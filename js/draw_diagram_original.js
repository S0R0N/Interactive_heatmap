...
{
    let max_number_of_nodes_to_leaf = genome_properties_tree.max_nodes_to_leaf();//FLAG the width is the number of samples
...
{
    let number_leaf_nodes = genome_properties_tree.number_of_leaves();// FLAG to change for number of nodes!
